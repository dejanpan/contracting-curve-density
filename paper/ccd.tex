...
PR2~\cite{Wyrobek08PR1} robot. The tests were boostrapped using parameters from
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.7\columnwidth]{experiments/book_sift/stacked.jpg}
...
of the quantitative results. Video of the test is available online on: \url{http://www.youtube.com/watch?v=X2K-h4oHxig}.
...
\todos{Briefly explain the idea about the CCD tracker, briefly
explain the experiment and provide the link to youtube video.}
% \begin{figure}[htbp]
%   \begin{minipage}[t]{0.49\linewidth} 
%     \centering  
