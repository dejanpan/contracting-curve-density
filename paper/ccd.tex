...
\begin{figure}[htb]
  \centering
  \includegraphics[width=6cm]{images/pr2b.jpg}
...
\begin{figure}[htbp]
  ...
  \end{minipage} 
  \caption[Manual Initialization]{Segment a partially occluded book in
    a clutter by mannualy initialization.}
  \label{fig:book}
\end{figure}
In this experiment, we use the CCD approach to recognize a book
in a clutter and analyze the experimental results (Fig.~\ref{fig:book})% , apparently, the tracker has successfully
...
\caption[Result]{segmentation result}
\end{figure}
...
& $\kappa$ & $c$ & $h$ & $\Delta h$ &samples points & degree &dimension\\
\hline
manual initialization& 0.5 & 5 & 7 & 5 & 1.2 & 0.5 &0.25 &40 &2 & 60 & 4 & 6\\
\hline
sift initialization & 0.5 & 5 & 7 & 5 & 1.2 & 0.5 &0.25 &48 &1 & 80 & 4 & 6\\
\hline
