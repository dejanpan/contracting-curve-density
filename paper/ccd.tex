...
\begin{tikzpicture}
[auto,
decision/.style={diamond, draw=blue, thick, fill=violet!20,
text width=5em, text badly centered,
inner sep=1pt},
block1/.style ={rectangle, draw=blue, thick, fill=blue!20,
text width=6em, text centered, rounded corners,
minimum height=5em},
block2/.style ={rectangle, draw=blue, thick, fill=red!20,
text width=6em, text centered, rounded corners,
minimum height=5em},
block3/.style ={rectangle, draw=blue, thick, fill=pink!20,
text width=6em, text centered, rounded corners,
minimum height=5em},
block5/.style ={rectangle, draw=blue, thick, fill=green!20,
text width=6em, text centered, rounded corners,
minimum height=5em},
line/.style ={draw, thick, -latex',shorten >=2pt},
cloud/.style ={draw=red, thick, ellipse,fill=red!50,
