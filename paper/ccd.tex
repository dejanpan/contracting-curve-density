...
\caption{Classification problem: When the outliers 
are added to this example set of points the probit activation
function (violet line) misclassifies the set.}
\label{fig:outliers}
\end{figure}
...
of robotic folding. We ran the algorithm 100 times where we substaintally varied
the pose of the initally projected T-shirt hull. The algorithm failed 4 times and took
