...
\begin{figure}[htbp]
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
        \subfloat[the origin image]{\includegraphics[width=2.5in]{images/segmentation/flowers.png}}
  \end{minipage}% 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[the ROI]{\includegraphics[width=2.5in]{images/segmentation/flowers_m.png}}
  \end{minipage}
...
\begin{figure}[htbp] 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[Sobel]{\includegraphics[width=2.5in]{images/flowers_sobel.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[Watershed algorithm]{\includegraphics[width=2.5in]{images/flowers_watershed.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[Graph cut]{\includegraphics[width=2.5in]{images/flowers_graph.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[Kmeans++]{\includegraphics[width=2.5in]{images/flowers_kmeans.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[Expectation and Maximization]{\includegraphics[width=2.5in]{images/flowers_em.png}}
  \end{minipage}
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[CCD]{\includegraphics[width=2.5in]{images/flowers_ccd.png}}
  \end{minipage}% 
...
\begin{figure}[htbp] 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
        \subfloat[iteration 1]{\includegraphics[width=2.5in]{images/ball/0.png}}
  \end{minipage}% 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 3]{\includegraphics[width=2.5in]{images/ball/2.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 7]{\includegraphics[width=2.5in]{images/ball/6.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 16]{\includegraphics[width=2.5in]{images/ball/15.png}}
  \end{minipage} 
...
\begin{figure}[htbp] 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 1]{\includegraphics[width=2.5in]{images/ball_normal/0.png}}
  \end{minipage}% 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 3]{\includegraphics[width=2.5in]{images/ball_normal/1.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 5]{\includegraphics[width=2.5in]{images/ball_normal/3.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 6]{\includegraphics[width=2.5in]{images/ball_normal/4.png}}
  \end{minipage} 
...
\begin{figure}[htbp]
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[]{\includegraphics[width=2.5in]{images/box1.png}}
  \end{minipage}% 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[]{\includegraphics[width=2.5in]{images/box2_mismatch.png}}
  \end{minipage} 
...
\begin{figure}[htbp]
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[]{\includegraphics[width=2.5in]{images/box2_3d.png}}
  \end{minipage}% 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[]{\includegraphics[width=2.5in]{images/box2_ok.png}}
  \end{minipage} 
...
\begin{figure}[htbp] 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 1]{\includegraphics[width=2.5in]{images/container/0.png}}
  \end{minipage}% 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 2]{\includegraphics[width=2.5in]{images/container/1.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 4]{\includegraphics[width=2.5in]{images/container/2.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 7]{\includegraphics[width=2.5in]{images/container/5.png}}
  \end{minipage} 
...
\begin{figure}[htbp] 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 1]{\includegraphics[width=2.5in]{images/bottle/0.png}}
  \end{minipage}% 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 2]{\includegraphics[width=2.5in]{images/bottle/1.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 3]{\includegraphics[width=2.5in]{images/bottle/2.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 21]{\includegraphics[width=2.5in]{images/bottle/20.png}}
  \end{minipage} 
...
\begin{figure}[htbp] 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering  
    \subfloat[iteration 1]{\includegraphics[width=2.5in]{images/book/0.png}}    
  \end{minipage}% 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 2]{\includegraphics[width=2.5in]{images/book/1.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 3]{\includegraphics[width=2.5in]{images/book/2.png}}
    \label{subfig:iteration 3}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[iteration 14]{\includegraphics[width=2.5in]{images/book/13.png}}
  \end{minipage}
  \begin{minipage}[t]{\linewidth} 
    \centering 
    \subfloat[segmentation of edge-based algorithm]{\includegraphics[width=0.8\linewidth]{images/book/book_sobel.png}}
  \end{minipage} 
...
\begin{figure}[htbp]
  \begin{minipage}[t]{0.5\linewidth} 
    \centering  
    \subfloat[Sampled frame 1]{\includegraphics[width=2.5in]{images/sift/1.png}}    
  \end{minipage}% 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[Sampled frame 2]{\includegraphics[width=2.5in]{images/sift/10.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[Sampled frame 3]{\includegraphics[width=2.5in]{images/sift/30.png}}
    \label{subfig:iteration 3}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[Sampled frame 4]{\includegraphics[width=2.5in]{images/sift/45.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[Sampled frame 5]{\includegraphics[width=2.5in]{images/sift/63.png}}
  \end{minipage} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[Sampled frame 6]{\includegraphics[width=2.5in]{images/sift/80.png}}
  \end{minipage} 
