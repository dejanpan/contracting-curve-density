...
\begin{figure} 
  \begin{minipage}[t]{0.45\linewidth} 
    \centering 
        \subfloat[the origin image]{\includegraphics[width=2.0in]{images/segmentation/flowers.png}}
  \end{minipage}% 
  \begin{minipage}[t]{0.45\linewidth} 
    \centering 
    \subfloat[the ROI]{\includegraphics[width=2.0in]{images/segmentation/flowers_m.png}}
  \end{minipage}
