...
\begin{figure} 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
        \subfloat[logistic sigmoid function]{\includegraphics[width=8.0cm]{images/logistic.png}}
  \end{minipage}% 
  \begin{minipage}[t]{0.5\linewidth} 
    \centering 
    \subfloat[error function]{\includegraphics[width=8.0cm]{images/erf.png}}
  \end{minipage} 
...
\begin{figure} 
  \begin{minipage}[t]{0.45\linewidth} 
    \centering 
        \subfloat[]{\includegraphics[width=2.0in]{images/weight1.png}}
  \end{minipage}% 
  \begin{minipage}[t]{0.45\linewidth} 
    \centering 
    \subfloat[]{\includegraphics[width=2.0in]{images/weight2.png}}
  \end{minipage} 
